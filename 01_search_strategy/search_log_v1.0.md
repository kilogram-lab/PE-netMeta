...
| CENTRAL | Cochrane Library, Trials/CENTRAL | 2026-06-22 | User + Codex | Main broad search | `search_strategy_v1.0.md`, CENTRAL single-box Title Abstract Keyword strategy | Inception to search date; no language restriction; Trials/CENTRAL tab selected | 3912 | `records_exports/20260622_central_trials_3912.ris` | RIS export verified locally by counting 3912 `TY  -` records and 3912 `ER  -` records. File includes CENTRAL accession (`AN`), PubMed/Embase cross-reference field (`C3`) where available, trial keywords, and source metadata. |
...
PubMed main, risk-enriched supplementary, device-term supplementary searches, Embase main search, and CENTRAL Trials search are complete. Next, execute Web of Science, ClinicalTrials.gov, WHO ICTRP, CNKI, Wanfang, VIP, and SinoMed/CBM searches and append results to this log.
