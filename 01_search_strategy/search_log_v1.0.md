...
PubMed main, risk-enriched supplementary, and device-term supplementary searches are complete. Next, execute Embase, CENTRAL, Web of Science, ClinicalTrials.gov, WHO ICTRP, CNKI, Wanfang, VIP, and SinoMed/CBM searches and append results to this log.
